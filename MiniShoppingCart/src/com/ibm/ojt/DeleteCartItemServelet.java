...
/**
 * Servlet implementation class DeleteCartItemServelet
 */
@WebServlet("/DeleteCartItemServelet")
public class DeleteCartItemServelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteCartItemServelet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		cust.getShoppingCart().deleteItem(prod);
