					...
					<table class="col-md-offset-1 col-md-10">
						<tbody>
							<tr>
								...
								<td colspan="2" class="col-md-9"><form:input type="text" path="user.emailId" placeholder="emailaddress@company.com" class="form-control" required/></td>
							</tr>
							<tr>
								...
								<td colspan="2"  class="col-md-9"> <form:input type="password" path="user.passwd" placeholder="Password" class="form-control" required/></td>
							</tr>
							...
							<tr>
								...
								<td class="col-md-9">
								<form:select path="employee.projects">
								 	<form:option value="" label="--Please Select"/>
						        	<form:options value="${projectlist}" itemValue="projectID" itemLabel="projectName"/>
								</form:select>
								</td>
							</tr>
							<tr>
